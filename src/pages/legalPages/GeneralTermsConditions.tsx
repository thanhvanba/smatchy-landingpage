...
// import { GenTerCon } from "../../config/legalPagesConfig";
// import { usePostBySlug } from "../../hooks/usePost";
// import Loading from "../../components/Loading";

// export default function CookiePolicy() {
//   const { locale } = useLocale();
//   const { data, isLoading, isError, error } = usePostBySlug(
...
//                 {(GenTerCon.titleHighlight as any)[locale]}
//               </span>
//               {(GenTerCon.titleEnd as any)[locale]}
//               <img
...
//                       <li
//                         key={itemIndex}
//                         className="ml-6 text-xs md:text-sm lg:text-base"
//                       >
//                         {item}
//                       </li>
//                     ))}
      ...
      <div className="container">
        ...
        <div className="relative flex flex-col gap-3 md:gap-4 lg:gap-6 bg-[#E2F6F6] shadow rounded-2xl p-4 md:p-6 lg:p-8 mt-8 md:mt-16 lg:mt-20 mb-52 z-40">
          <div
            ...
            data-aos-duration="1000"
          >
            <h2 className="relative text-xl md:text-2xl lg:text-5xl text-[#0A4A60] font-bold pt-2 md:pt-3 lg:pt-4">
              <span className="text-[#FCA13B]">
                {(GenTerCon.titleHighlight as any)[locale]}
              </span>
              {(GenTerCon.titleEnd as any)[locale]}
