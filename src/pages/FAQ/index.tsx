  ...
  const filteredFaqs = useMemo(() => {
    return faqs.filter((item: FAQItem) => {
      ...
      const matchesCategory =
        selectedCategory === allLabel || categoryName === selectedCategory;

      return matchesSearch && matchesCategory;
    });
  }, [faqs, searchTerm, selectedCategory, allLabel]);
              ...
              <div className="flex gap-2 overflow-x-auto pb-2 hide-scrollbar">
                {categories.map((category, index) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full whitespace-nowrap shrink-0 cursor-pointer ${
